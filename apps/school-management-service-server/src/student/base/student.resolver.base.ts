...
export class StudentResolverBase {
  ...
  async createStudent(
    ...
    return await this.service.createStudent({
      ...
      data: {
        ...
        major: args.data.major
          ? {
              connect: args.data.major,
            }
          : undefined,
      },
    });
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [Abscence], { name: "abscences" })
  @nestAccessControl.UseRoles({
    resource: "Abscence",
    action: "read",
    possession: "any",
  ...
  async findAbscences(
    ...
    const results = await this.service.findAbscences(parent.id, args);
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [Marks], { name: "marksItems" })
  @nestAccessControl.UseRoles({
    resource: "Marks",
    action: "read",
    possession: "any",
  ...
  async findMarksItems(
    @graphql.Parent() parent: Student,
    @graphql.Args() args: MarksFindManyArgs
  ): Promise<Marks[]> {
    const results = await this.service.findMarksItems(parent.id, args);
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [Remarks], { name: "remarksItems" })
  @nestAccessControl.UseRoles({
    resource: "Remarks",
    action: "read",
    possession: "any",
  ...
  async findRemarksItems(
    ...
    const results = await this.service.findRemarksItems(parent.id, args);
  ...
  async getMajor(@graphql.Parent() parent: Student): Promise<Major | null> {
    const result = await this.service.getMajor(parent.id);
  ...
  @graphql.Mutation(() => SignUpOutput)
  async StudentSignUp(
    @graphql.Args()
    args: SignUpInput
  ): Promise<SignUpOutput> {
    return this.service.StudentSignUp(args);
  }
}
